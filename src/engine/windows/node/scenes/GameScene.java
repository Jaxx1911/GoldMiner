...
public class GameScene extends Scene{
    ...
    public GameScene(GameWindows gameWindows) {
        ...
        pig = new Pig(0, new Position(400, 400), taker);
        listGameObject.add(pig);
    }
    ...
    public void initLevel(Taker taker) {
        level1 = new Level(taker, 1, 0, 2, 0, 3, 5, 2 ,2, 1, 0, 1);
        level2 = new Level(taker, 2, 1,1, 1, 2, 5,2,3,1, 0, 0);
        level3 = new Level(taker,3, 2,3,1,2,4,3,1,2, 0, 0);
        level4 = new Level(taker, 4,5,0,0,0,7,4,4,0, 0, 0);
        level5 = new Level(taker, 5,3, 2,3,3,5,3,2,2, 0, 0);
